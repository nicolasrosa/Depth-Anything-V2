...
if __name__ == '__main__':
    ...
    # parser.add_argument('--max-depth', type=float, default=20)  # Max Depth for indoor model
    parser.add_argument('--max-depth', type=float, default=80)  # Max Depth for outdoor model
